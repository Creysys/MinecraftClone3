...
namespace MinecraftClone3API.Graphics
{
    public class VertexArrayObject : IDisposable
    {
        ...
        public void Add(Vector3 position, Vector4 texCoord, Vector4 overlayTexCoord, Vector4 normal, Vector4 color, Vector4 overlayColor)
        {
            if (_positions == null)
            {
        ...
        public void Draw() => Draw(BeginMode.Triangles);
